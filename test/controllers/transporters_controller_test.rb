...
class TransportersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transporter" do
    assert_difference('Transporter.count') do
      post transporters_url, params: { transporter: { name: @transporter.name, siret: @transporter.siret } }, as: :json
    end
  ...
  test "should update transporter" do
    patch transporter_url(@transporter), params: { transporter: { name: @transporter.name, siret: @transporter.siret } }, as: :json
    assert_response 200
  end
